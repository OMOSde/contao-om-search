...
class ModuleOmSearchKeywords extends BackendModule
{
    ...
    public function generateOutput()
    {
        ...
        $this->Template->topKeywords = $objDatabase->prepare("SELECT DISTINCT id,keyword,COUNT(*) as count FROM tl_om_search_keywords" . $strWhere . " GROUP BY keyword ORDER BY count DESC LIMIT 30")->execute()->fetchAllAssoc();
